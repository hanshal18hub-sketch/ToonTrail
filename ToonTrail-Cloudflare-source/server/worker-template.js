...
const item=(id,english,romaji,native,kind,status,description,genres,links)=>({id,title:{english,romaji,native},kind,format:kind,status,description,genres,chapters:null,coverImage:{large:"",color:null},averageScore:0,popularity:0,siteUrl:links[0].url,externalLinks:links.map(x=>({site:x.site,url:x.url,type:x.type||"OFFICIAL",language:"English",isDisabled:false}))});
const CATALOG=[
 ...
 item(10014,"Apotheosis","Apotheosis","百炼成神","Manhua","RELEASING","A fallen young master begins a cultivation journey through a world of martial power and dangerous rivals.",["Action","Cultivation","Fantasy"],[{site:"INKR — officially licensed manhua catalogue",url:"https://comics.inkr.com/manhua"}]),
